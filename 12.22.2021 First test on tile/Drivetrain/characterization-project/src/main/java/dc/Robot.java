...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(14, Sides.LEFT, false);

    WPI_TalonFX leftFollowerID16 = setupWPI_TalonFX(16, Sides.FOLLOWER, false);
    leftFollowerID16.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(12, Sides.RIGHT, true);
    WPI_TalonFX rightFollowerID18 = setupWPI_TalonFX(18, Sides.FOLLOWER, true);    
    rightFollowerID18.follow(rightMotor);
    drive = new DifferentialDrive(leftMotor, rightMotor);
    drive.setDeadband(0);


    WPI_TalonFX eleven = new WPI_TalonFX(11);
    eleven.setNeutralMode(NeutralMode.Brake);
    WPI_TalonFX thirteen = new WPI_TalonFX(13);
    thirteen.setNeutralMode(NeutralMode.Brake);
    WPI_TalonFX fifteen = new WPI_TalonFX(15);
    fifteen.setNeutralMode(NeutralMode.Brake);
    WPI_TalonFX seventeen = new WPI_TalonFX(17);
    seventeen.setNeutralMode(NeutralMode.Brake);
